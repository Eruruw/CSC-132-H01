...
class Game(Frame):
    ...
    def setupGUI(self):
        ...
        text_frame = Frame(self, height=int(HEIGHT // 4))
...
def dialogueSearch(index):
    ...
    if index == "c-pa2":
        ...
        response = ("Ok, maybe that could work." \
                    ...
                    "\n\n - How about a word-sorter?" \
                    "\n - We could do something with a GUI." \
                    "\n - Oh! A soundboard!" \
                    "\n - No, do you?")
        k.append_item("k-pa1")
        k.append_item("k-pa2")
    ...
    if index == "d1":
        ...
        response = ("That's good to hear." \
                    ...
                    "\n\n - I sure hope so." \
                    "\n - Isn't that a little too optimisitc?")
        l.append_item("e1")
        l.append_item("e2")
        partnerOpinion += 1
        LL = l
...
def determineEnding():
    ...
    if(loopEnding == True):
        ...
        ending = ("Ending: Best Ending" \
                  ...
                  "\nTheir friendship and understanding heloped them finish the project." \
